...
- **IESEG School of Management** – *Business Analyst Apprentice (Jan 2025 – May 2025)*  
  ...
  - Delivered real-time insights for sustainable tourism and hospitality.

- **IESEG School of Management** – *Business Analyst Intern (Sept 2024 – Dec 2024)*  
  - Built a churn prediction model using Python and ML for Orange Telkom.
  - Coordinated software product evaluations and vendor meetings.

- **MITSUMI** – *Technology Specialist (May 2022 – Jun 2024)*  
  - Managed IT infrastructure and automated tasks using scripts.
  - Delivered client solutions and handled stakeholder management.
